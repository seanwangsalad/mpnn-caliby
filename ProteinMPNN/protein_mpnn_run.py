...
from helper_scripts.parse_multiple_chains import parse_multiple_chains
from helper_scripts.assign_fixed_chains import assign_fixed_chains
from helper_scripts.make_fixed_positions_dict import make_fixed_positions_dict
...
def main(args):
    ...
    elif parsed_chain_dict_list:
        dataset_valid = StructureDataset(parsed_chain_dict_list, truncate=None, max_length=args.max_length, verbose=print_all)
    else:
    ...
    base_folder = os.path.abspath(folder_for_outputs)
    if base_folder[-1] != '/':
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--folder_with_pdbs_path", type=str, help="path of pdb")   
    argparser.add_argument("--chain_list", type=str, default='', help="List of the chains that need to be fixed")
    argparser.add_argument("--position_list", type=str, default=False, help="Position lists, e.g. 11 12 14 18, 1 2 3 4 for first chain and the second chain")
